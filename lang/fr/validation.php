...
return [
    ...
    'max' => [
        ...
        'file' => 'La taille du fichier de :attribute ne peut pas être supérieure à :max kilo-octets.',
    ...
    'min' => [
        ...
        'file' => 'La taille du fichier de :attribute doit être au minimum :min kilo-octets.',
        'numeric' => 'La valeur de :attribute doit être au minimum :min.',
    ...
    'prohibited_unless' => 'Le champ :attribute est interdit sauf si :other est l\'une des valeurs :values.',
    'prohibits' => 'Le champ :attribute interdit la présence de :other.',
    'regex' => 'Le format du champ :attribute est invalide.',
    'required' => 'Le champ :attribute est obligatoire.',
    'required_array_keys' => 'Le champ :attribute doit contenir des entrées pour : :values.',
    'required_if' => 'Le champ :attribute est obligatoire quand la valeur :other est :value.',
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez définir ci-dessous des messages qui remplacent ceux par défaut
    | en fonction d'un nom d'attribut donné.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez définir ci-dessous des libellés d'attributs qui remplacent
    | les noms techniques (ex: "email", "password") par des libellés français.
    |
    */
